...
import re
from Specs.abstract.linux.cpuAbs import CpuAbs
...
################################################################################
    ...
    def is_hyperthreaded(self):
        ...
        ht = False
        for sibling in self.configuration.file_siblings():
    ...
    def get_raw_core_count(self):
        ...
        for line in self.configuration.file_sys_cpu():
            core = line.split('-')
    ...
    def get_socket_count(self):
        ...
        while count < self.rawCoreCount:
            sysCpuSocketId = self.configuration.sys_cpu_socket_id(count)
    ...
    def get_core_freq_list(self):
        ...
        while count < self.realCoreCount:
            eachSysCpuCoreFreq = self.configuration.sys_cpu_core_freq(count)
    ...
    def get_brand(self):
        ...
        return self.configuration.clean_cpu_list(self.configuration.get_info_dict()['model name'])
    #end
    ...
    def get_flags(self):
        ...
        for flag in self.configuration.get_info_dict()['flags'].split(' '):
    ...
    def get_max_frequency(self):
        ...
        return self.__get_frequency(self.configuration.file_cpu_max_freq())
    #end
...
################################################################################
    ...
    def __set_unified_cache_level(self):
        ...
        maxCacheLevel = self.configuration.max_cache_level()
    ...
    def __get_raw_cache_dict(self):
        ...
        while index < maxCacheLevel:
            eachSysCpuCacheLevel = self.configuration.sys_cpu_cache_level(index)
